...
const LogoutLink = () => {
  return getAuthMethod() === AuthMethod.Auth0 ? (
    <Link
      style={{
        marginLeft: "10px",
        marginTop: "8px",
          ...
          <Grid item xs={9}>
            ...
            >
              ...
              <div style={{ width: 24, height: 24 }}>
                <FontAwesomeIcon
                  icon={faComments}
                  style={{ color: "rgba(240, 148, 114, 1)" }}
                />
              </div>
              <div
                style={{
              ...
              >
                {showOptions && (
                  ...
                  >
                    ...
                    >
                      <MenuItem
                        value={Capabilities.TalkToMyData}
                        style={{
                          color: "rgba(0, 0, 0, 0.6)",
                          fontWeight: 400,
                          fontSize: 15,
                      ...
                      <MenuItem
                        value={Capabilities.CypherGenie}
                        style={{
                          color: "rgba(0, 0, 0, 0.6)",
                          fontWeight: 400,
                          fontSize: 15,
